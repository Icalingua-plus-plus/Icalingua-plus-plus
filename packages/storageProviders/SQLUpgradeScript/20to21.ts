...
const obsoleteIndexColumns = [
    ['roomId', 'time', '_id'],
    ['senderId', 'roomId', 'time', '_id'],
]
...
const upg20to21 = async (db: Knex) => {
    ...
    await db<DBVersion>('dbVersion').update({ dbVersion: 21 })
}

export default upg20to21

...
export default {
    ...
    data() {
        return {
            svgItem: [
                ...
                {
                    name: 'message-star',
                    path: 'M20,2H4C2.9,2 2,2.9 2,4V22L6,18H20C21.1,18 22,17.1 22,16V4C22,2.9 21.1,2 20,2M20,16H5.17L4,17.17V4H20V16M12,5.75L13.16,8.1L15.75,8.48L13.88,10.3L14.32,12.88L12,11.66L9.68,12.88L10.12,10.3L8.25,8.48L10.84,8.1L12,5.75Z',
                },
                {
                    name: 'close',
                ...
                {
                    name: 'plus-one',
                    path: 'M10,8V12H14V14H10V18H8V14H4V12H8V8H10M18,8H20V18H18V10H16V8H18Z',
                },
                {
                    name: 'more',
    ...
    computed: {
        ...
        size() {
            return this.svgItem.find((item) => item.name === this.name).large ? '512' : '24'
        },
    },
}
</script>
